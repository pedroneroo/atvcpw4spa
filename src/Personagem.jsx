...
export default function Personagem() {
  ...
  function toggleFavorito() {
    ...
    if (favoritos.includes(nome)) {
      novaLista = favoritos.filter(item => item !== nome);
    } else {
      novaLista = [...favoritos, nome];
    }
    ...
    >
      ...
      <button
        ...
        style={{
          ...
          borderRadius: "10px",
          border: "none",
          backgroundColor: favoritos.includes(nome) ? "#ff4d4d" : "#4CAF50",
          color: "white",
          fontWeight: "bold",
          marginBottom: "10px"
        }}
      >
        {favoritos.includes(nome) ? "✖️ Remover dos Favoritos" : "✅ Favoritar"}
      </button>
